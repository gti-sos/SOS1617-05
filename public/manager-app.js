...
angular.module("ManagerApp", ["ngRoute"]).config(function($routeProvider) {
    ...
    $routeProvider
        ...
        }).when("/elections-results/widgets/zalando", { /* EDUCATION CHART (PROXY) */
            templateUrl: "frontends/nacho/zalandoChart.html",
            controller: "ZalandoCtrl"
        }) //ALBERTO
        ...
        }).when("/economic-situation/widgetsProxy2", {
            templateUrl: "frontends/alberto/proxy2-widgets.html",
            controller: "Proxy2EconomicWidgetsCtrl"
        });
